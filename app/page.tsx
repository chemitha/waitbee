      ...
      <main className={styles.main}>
        <div className={styles.hero}>
          ...
          <div className={styles.trustText}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <path d="m10.273 2.513-.921-.944.715-.698.622.637.89-.011a2.89 2.89 0 0 1 2.924 2.924l-.01.89.636.622a2.89 2.89 0 0 1 0 4.134l-.637.622.011.89a2.89 2.89 0 0 1-2.924 2.924l-.89-.01-.622.637a2.89 2.89 0 0 1-4.134 0l-.622-.637-.89.01a2.89 2.89 0 0 1-2.924-2.924l.01-.89-.636-.622a2.89 2.89 0 0 1 0-4.134l.637-.622-.011-.89a2.89 2.89 0 0 1 2.924-2.924l.89.01.622-.637a2.89 2.89 0 0 1 4.134 0"/>
            </svg>
        ...
        <div className={styles.heroContainer}>
          <div className={styles.heroText}>
            <h2>How WaitBee Works</h2>
            <p>Three simple steps to launch your viral waitlist</p>
          </div>
